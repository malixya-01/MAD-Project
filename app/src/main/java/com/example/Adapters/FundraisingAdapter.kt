...
import com.example.DataClasses.FundraisingData
...
class FundraisingAdapter(var mList: List<FundraisingData>) :
    ...
    inner class FundraisingViewHolder(itemView: View, listner: onItemClickListner) :RecyclerView.ViewHolder(itemView) {
